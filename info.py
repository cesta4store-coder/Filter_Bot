...
API_ID = int(environ.get('API_ID', '21575196')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'ed2748ad0d2844020703b538f20f7518')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8513386358:AAEQcWEIfeLSDlm9QBVB3zjDYib7IgxSJyw")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5728831202').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003234392838').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003193726700'))  # Log channel id (make sure bot is admin)
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003219292353').split()] #(make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/iet_owner')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003292992718")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cesta4store_db_user:<db_password>@cluster0.zsedgus.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003193726700')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003193726700')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviehubbmalayalam') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/moviehubbmalayalam') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/moviehubbmalayalam') # Update channel link for the bot
